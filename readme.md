...
|---------------- |------------------- |-----------------:|-----------------:|-----------------:|-----------------:|------:|--------:|-----------:|-----------:|----------:|------------:|
|        Baseline |                  8 |         509.2 ns |         9.912 ns |        13.896 ns |         543.5 ns |  1.00 |    0.00 |     0.2775 |          - |         - |       872 B |
| BestNonParallel |                  8 |         229.1 ns |         3.237 ns |         3.028 ns |         233.0 ns |  0.45 |    0.01 |     0.0076 |          - |         - |        24 B |
|    BestParallel |                  8 |       7,296.8 ns |       143.746 ns |       186.910 ns |       7,606.0 ns | 14.33 |    0.50 |     0.5646 |          - |         - |      1768 B |
|                 |                    |                  |                  |                  |                  |       |         |            |            |           |             |
|        Baseline |                512 |   1,009,588.6 ns |    14,018.207 ns |    12,426.775 ns |   1,030,152.1 ns |  1.00 |    0.00 |   181.6406 |    89.8438 |         - |   1071368 B |
| BestNonParallel |                512 |     672,025.2 ns |     8,594.207 ns |     7,618.540 ns |     680,534.5 ns |  0.67 |    0.01 |          - |          - |         - |        24 B |
|    BestParallel |                512 |     526,387.7 ns |    10,140.359 ns |     7,916.926 ns |     536,668.8 ns |  0.52 |    0.01 |     0.9766 |          - |         - |      2664 B |
|                 |                    |                  |                  |                  |                  |       |         |            |            |           |             |
|        Baseline |               8192 | 457,664,260.0 ns | 6,437,626.189 ns | 6,021,759.532 ns | 471,844,400.0 ns |  1.00 |    0.00 | 46000.0000 | 24000.0000 | 4000.0000 | 268796168 B |
...
Multi-op is where the inner most for-loop is unrolled a certain number of times. The idea is that this may avoid a few extra instructions that, when hit millions of times, would turn into a performance boost.

|   Method | NumberOfCharacters |             Mean |            Error |           StdDev |              Max | Ratio | RatioSD |      Gen 0 |      Gen 1 |     Gen 2 |   Allocated |
|--------- |------------------- |-----------------:|-----------------:|-----------------:|-----------------:|------:|--------:|-----------:|-----------:|----------:|------------:|
| Baseline |                  8 |         484.2 ns |         6.762 ns |         5.995 ns |         494.5 ns |  1.00 |    0.00 |     0.2775 |          - |         - |       872 B |
| DoubleOp |                  8 |         442.8 ns |         8.082 ns |         7.560 ns |         450.1 ns |  0.91 |    0.02 |     0.2780 |          - |         - |       872 B |
|   QuadOp |                  8 |         466.4 ns |         7.298 ns |         5.698 ns |         471.1 ns |  0.96 |    0.02 |     0.2780 |          - |         - |       872 B |
|          |                    |                  |                  |                  |                  |       |         |            |            |           |             |
| Baseline |                128 |      62,389.5 ns |     1,045.628 ns |       926.922 ns |      63,501.3 ns |  1.00 |    0.00 |    22.7051 |          - |         - |     71432 B |
| DoubleOp |                128 |      52,186.4 ns |     1,031.182 ns |       964.569 ns |      53,480.0 ns |  0.84 |    0.02 |    22.7661 |          - |         - |     71432 B |
|   QuadOp |                128 |      54,309.2 ns |     1,055.024 ns |     1,083.432 ns |      56,041.5 ns |  0.87 |    0.02 |    22.7661 |          - |         - |     71432 B |
|          |                    |                  |                  |                  |                  |       |         |            |            |           |             |
| Baseline |                512 |   1,030,666.0 ns |    19,348.435 ns |    18,098.538 ns |   1,055,568.8 ns |  1.00 |    0.00 |   183.5938 |    91.7969 |         - |   1071368 B |
| DoubleOp |                512 |     875,344.9 ns |    17,403.387 ns |    16,279.139 ns |     900,094.5 ns |  0.85 |    0.02 |   181.6406 |    90.8203 |         - |   1071368 B |
|   QuadOp |                512 |     924,562.1 ns |    10,981.500 ns |     9,170.050 ns |     941,150.0 ns |  0.90 |    0.02 |   182.6172 |    90.8203 |         - |   1071368 B |
|          |                    |                  |                  |                  |                  |       |         |            |            |           |             |
| Baseline |               2048 |  26,414,709.6 ns |   136,147.237 ns |   120,690.979 ns |  26,600,515.6 ns |  1.00 |    0.00 |  3062.5000 |  1375.0000 |  562.5000 |  16867592 B |
| DoubleOp |               2048 |  23,648,070.2 ns |   242,059.839 ns |   226,422.923 ns |  23,975,740.6 ns |  0.89 |    0.01 |  3062.5000 |  1375.0000 |  562.5000 |  16867592 B |
|   QuadOp |               2048 |  24,717,601.1 ns |   353,912.250 ns |   313,733.992 ns |  25,544,065.6 ns |  0.94 |    0.01 |  3062.5000 |  1375.0000 |  562.5000 |  16867592 B |
|          |                    |                  |                  |                  |                  |       |         |            |            |           |             |
| Baseline |               8192 | 459,087,393.3 ns | 7,225,148.247 ns | 6,758,408.153 ns | 472,982,000.0 ns |  1.00 |    0.00 | 46000.0000 | 24000.0000 | 4000.0000 | 268796168 B |
| DoubleOp |               8192 | 414,571,360.0 ns | 5,168,900.924 ns | 4,834,993.131 ns | 424,430,900.0 ns |  0.90 |    0.02 | 46000.0000 | 24000.0000 | 4000.0000 | 268796168 B |
|   QuadOp |               8192 | 431,144,666.7 ns | 6,968,354.865 ns | 6,518,203.464 ns | 441,349,200.0 ns |  0.94 |    0.01 | 46000.0000 | 24000.0000 | 4000.0000 | 268796168 B |